...
class ScorerDatasetReader(InferenceDatasetReader):
    ...
    def __getitem__(self, index):
        ...
        #print("$$$$$$$$$$$$$$$$$$$$$$$$$ scoring_dsr ScorerDatasetReader tokenized_labels:{}".format(tokenized_labels))                                               
        #print("$$$$$$$$$$$$$$$$$$$$$$$$$ scoring_dsr ScorerDatasetReader entry:{}".format(entry))
        #print("$$$$$$$$$$$$$$$$$$$$$$$$$ scoring_dsr ScorerDatasetReader answer:{}".format(answer))
